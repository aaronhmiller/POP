...
3. The commit kicks off your workflows, so FINALLY we see what we came here for...from the repo's main area, select the "flows running" icon indicator and you should see three order independent flows:
   - [Node (Latest)](https://hub.docker.com/_/node/tags?name=latest)
   - [Chainguarded Node](https://images.chainguard.dev/directory/image/node/compare)
...
## Versions
0.0.1k (honoring & paraphrasing [JWZ](https://www.jwz.org/) who said something once like "quality is job 1.1a")
